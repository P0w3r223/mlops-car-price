"""mlops-car-price: keeping the used-car price model alive, measured and replaceable.

The modelling code is not reimplemented here — it is consumed from the ``car_price_ml``
package (pinned to a tag). This package adds the layer around it: versioned
